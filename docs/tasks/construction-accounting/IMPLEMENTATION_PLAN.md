...
- [ ] Deliver WIP + cash reconciliation views/materialized tables tied to GL (`project_wip_summary`, `project_cash_positions`).
- [ ] Expose reporting APIs/UI dashboards and document reconciliation workflows.
...
| ☐ TODO | Publish WIP & cash reports | | After posting rules validated |
