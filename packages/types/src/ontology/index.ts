...
export const ontologyApiPathSchema = z.string().regex(/^\/v1\/[a-zA-Z0-9/_{}-]+$/);
...
export const STANDARD_ONTOLOGY_RECORDS: OntologyRecordDefinition[] = [
  ...
  standardRecord({
    ...
    apiPath: '/v1/transactions/{transactionId}/lines',
  ...
  standardRecord({
    ...
    apiPath: '/v1/revenue-arrangements',
  ...
  standardRecord({
    ...
    apiPath: '/v1/gl-transactions/{transactionId}/lines',
  ...
  standardRecord({
    ...
    apiPath: '/v1/schedules-of-values',
  ...
  standardRecord({
    ...
    apiPath: '/v1/custom-field-definitions',
  ...
  standardRecord({
    ...
    apiPath: '/v1/custom-record-types',
