...
export const glAuditTrail = pgTable('gl_audit_trail', {
  ...
  entityIdx: uniqueIndex('idx_audit_entity').on(table.entityId, table.timestamp),
}));

export const glAuditTrailRelations = relations(glAuditTrail, ({ one }) => ({
  entity: one(entities, {
    fields: [glAuditTrail.entityId],
    references: [entities.id],
  }),
}));
