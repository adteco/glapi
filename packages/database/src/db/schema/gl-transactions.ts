import { pgTable, text, boolean, jsonb, timestamp, uniqueIndex, decimal, date, uuid, integer } from 'drizzle-orm/pg-core';
...
export const glTransactions = pgTable('gl_transactions', {
  ...
  reversedByTransactionId: uuid('reversed_by_transaction_id').references(() => glTransactions.id),
