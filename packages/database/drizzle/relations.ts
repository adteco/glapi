...
export const accountsRelations = relations(accounts, ({one, many}) => ({
	...
	items_assetAccountId: many(items, {
		relationName: "items_assetAccountId_accounts_id"
	}),
	items_cogsAccountId: many(items, {
		relationName: "items_cogsAccountId_accounts_id"
	}),
	items_expenseAccountId: many(items, {
		relationName: "items_expenseAccountId_accounts_id"
	}),
	items_incomeAccountId: many(items, {
		relationName: "items_incomeAccountId_accounts_id"
	}),
}));
...
export const unitsOfMeasureRelations = relations(unitsOfMeasure, ({one, many}) => ({
	transactionLines: many(transactionLines),
	items: many(items),
	assemblyComponents: many(assemblyComponents),
	unitsOfMeasure: one(unitsOfMeasure, {
		fields: [unitsOfMeasure.baseUnitId],
		references: [unitsOfMeasure.id],
		relationName: "unitsOfMeasure_baseUnitId_unitsOfMeasure_id"
	}),
	unitsOfMeasures: many(unitsOfMeasure, {
		relationName: "unitsOfMeasure_baseUnitId_unitsOfMeasure_id"
	}),
}));
...
export const itemsRelations = relations(items, ({one, many}) => ({
	...
	lotNumbers: many(lotNumbers),
	serialNumbers: many(serialNumbers),
	account_assetAccountId: one(accounts, {
	...
	account_cogsAccountId: one(accounts, {
	...
	account_incomeAccountId: one(accounts, {
	...
	item: one(items, {
		...
		references: [items.id],
		relationName: "items_parentItemId_items_id"
	}),
	items: many(items, {
		relationName: "items_parentItemId_items_id"
	}),
	...
	assemblyComponents_assemblyItemId: many(assemblyComponents, {
		relationName: "assemblyComponents_assemblyItemId_items_id"
	}),
	assemblyComponents_componentItemId: many(assemblyComponents, {
		relationName: "assemblyComponents_componentItemId_items_id"
	}),
	kitComponents_componentItemId: many(kitComponents, {
		relationName: "kitComponents_componentItemId_items_id"
	}),
	kitComponents_kitItemId: many(kitComponents, {
		relationName: "kitComponents_kitItemId_items_id"
	}),
	itemAuditLogs: many(itemAuditLog),
}));
...
export const itemCategoriesRelations = relations(itemCategories, ({one, many}) => ({
	itemCategory: one(itemCategories, {
		...
		references: [itemCategories.id],
		relationName: "itemCategories_parentCategoryId_itemCategories_id"
	}),
...
export const assemblyComponentsRelations = relations(assemblyComponents, ({one}) => ({
	item_assemblyItemId: one(items, {
		fields: [assemblyComponents.assemblyItemId],
		references: [items.id],
		relationName: "assemblyComponents_assemblyItemId_items_id"
	}),
	item_componentItemId: one(items, {
