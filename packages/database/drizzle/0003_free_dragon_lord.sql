...
--> statement-breakpoint
ALTER TABLE "gl_account_balances" DROP CONSTRAINT "gl_account_balances_period_id_accounting_periods_id_fk";
--> statement-breakpoint
ALTER TABLE "gl_transactions" DROP CONSTRAINT "gl_transactions_period_id_accounting_periods_id_fk";
--> statement-breakpoint
