-- Event Store Foundation Migration
-- glapi-80g: Implements event_store, event_outbox, and event_projections tables
-- This enables event sourcing patterns for complete auditability
