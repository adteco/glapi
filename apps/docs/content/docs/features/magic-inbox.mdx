...
3. Choose your email option:
   - **Shared Domain** - Get an email like `yourcompany@inbox.adteco.app`
...
4. Your email address is ready: `acme-corp@inbox.adteco.app`
...
{
  "enabled": true,
  "emailAddress": "acme@inbox.adteco.app",
  "emailType": "prefix",
  "prefix": "acme",
