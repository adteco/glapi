---
title: Revenue Enums Object
description: Revenue recognition enumeration types
---

# Revenue Enums Object

Represents a revenue enums entity in GLAPI.
...
- **Description**: Unique identifier for the revenue enums
...
// Example usage
const record = await client.revenueenumss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/revenue-enumss/123e4567-e89b-12d3-a456-426614174000',
