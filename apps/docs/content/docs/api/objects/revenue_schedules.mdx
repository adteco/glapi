---
title: Revenue_schedules Object
description: revenue_schedules entity schema and field reference
---

# Revenue_schedules Object

Represents a revenue_schedules entity in GLAPI.
...
- **Description**: Unique identifier for the revenue_schedules
...
// Example usage
const record = await client.revenue_scheduless.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/revenue_scheduless/123e4567-e89b-12d3-a456-426614174000',
