---
title: Cohort Analysis Object
description: Cohort analysis schema
---

# Cohort Analysis Object

Represents a cohort analysis entity in GLAPI.
...
- **Description**: Unique identifier for the cohort analysis
...
// Example usage
const record = await client.cohortanalysiss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/cohort-analysiss/123e4567-e89b-12d3-a456-426614174000',
