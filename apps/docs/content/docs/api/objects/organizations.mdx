...
description: Organization entity schema and field reference
---

# Organization Object

Represents a organization entity in GLAPI.
...
// Example usage
const record = await client.organizationss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/organizationss/123e4567-e89b-12d3-a456-426614174000',
