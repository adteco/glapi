---
title: Contract Modification Object
description: Contract modification schema and field reference
---

# Contract Modification Object

Represents a contract modification entity in GLAPI.
...
- **Description**: Unique identifier for the contract modification
...
// Example usage
const record = await client.contractmodificationss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/contract-modificationss/123e4567-e89b-12d3-a456-426614174000',
