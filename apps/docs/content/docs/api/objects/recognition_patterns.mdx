---
title: Recognition Pattern Object
description: Revenue recognition pattern schema
---

# Recognition Pattern Object

Represents a recognition pattern entity in GLAPI.
...
- **Description**: Unique identifier for the recognition pattern
...
// Example usage
const record = await client.recognition_patternss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/recognition_patternss/123e4567-e89b-12d3-a456-426614174000',
