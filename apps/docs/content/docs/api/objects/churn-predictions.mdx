---
title: Churn Prediction Object
description: Churn prediction schema
---

# Churn Prediction Object

Represents a churn prediction entity in GLAPI.
...
- **Description**: Unique identifier for the churn prediction
...
// Example usage
const record = await client.churnpredictionss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/churn-predictionss/123e4567-e89b-12d3-a456-426614174000',
