---
title: Rls Access Control Object
description: rls-access-control entity schema and field reference
---

# Rls Access Control Object

Represents a rls access control entity in GLAPI.
...
- **Description**: Unique identifier for the rls access control
...
// Example usage
const record = await client.rlsaccesscontrols.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/rls-access-controls/123e4567-e89b-12d3-a456-426614174000',
