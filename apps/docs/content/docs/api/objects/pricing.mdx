...
description: Pricing entity schema and field reference
---

# Pricing Object

Represents a pricing entity in GLAPI.
...
// Example usage
const record = await client.pricings.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/pricings/123e4567-e89b-12d3-a456-426614174000',
