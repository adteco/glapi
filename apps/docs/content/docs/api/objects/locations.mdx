...
description: Location entity schema and field reference
---

# Location Object

Represents a location entity in GLAPI.
...
// Example usage
const record = await client.locationss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/locationss/123e4567-e89b-12d3-a456-426614174000',
