---
title: Journal Entry Batch Object
description: Journal entry batch schema
---

# Journal Entry Batch Object

Represents a journal entry batch entity in GLAPI.
...
- **Description**: Unique identifier for the journal entry batch
...
// Example usage
const record = await client.journalentrybatchess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/journal-entry-batchess/123e4567-e89b-12d3-a456-426614174000',
