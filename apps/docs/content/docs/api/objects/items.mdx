---
title: Item Object
description: Item/Product entity schema and field reference
---

# Item Object

Represents a item entity in GLAPI.
...
// Example usage
const record = await client.itemss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/itemss/123e4567-e89b-12d3-a456-426614174000',
