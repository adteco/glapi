---
title: Accounting Period Object
description: Accounting period schema
---

# Accounting Period Object

Represents a accounting period entity in GLAPI.
...
// Example usage
const record = await client.accountingperiodss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/accounting-periodss/123e4567-e89b-12d3-a456-426614174000',
