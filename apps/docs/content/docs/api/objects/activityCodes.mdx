---
title: ActivityCodes Object
description: activityCodes entity schema and field reference
---

# ActivityCodes Object

Represents a activitycodes entity in GLAPI.
...
- **Description**: Unique identifier for the activitycodes
...
// Example usage
const record = await client.activityCodess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/activityCodess/123e4567-e89b-12d3-a456-426614174000',
