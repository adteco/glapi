---
title: Catch-up Adjustment Object
description: Revenue catch-up adjustment schema
---

# Catch-up Adjustment Object

Represents a catch-up adjustment entity in GLAPI.
...
- **Description**: Unique identifier for the catch-up adjustment
...
// Example usage
const record = await client.catchupadjustmentss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/catch-up-adjustmentss/123e4567-e89b-12d3-a456-426614174000',
