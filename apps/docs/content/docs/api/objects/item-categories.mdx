---
title: Item Category Object
description: Item category schema and field reference
---

# Item Category Object

Represents a item category entity in GLAPI.
...
// Example usage
const record = await client.itemcategoriess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/item-categoriess/123e4567-e89b-12d3-a456-426614174000',
