...
description: Subscription entity schema and field reference
---

# Subscription Object

Represents a subscription entity in GLAPI.
...
// Example usage
const record = await client.subscriptionss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/subscriptionss/123e4567-e89b-12d3-a456-426614174000',
