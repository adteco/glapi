---
title: Subsidiary Object
description: Subsidiary entity schema and field reference
---

# Subsidiary Object

Represents a subsidiary entity in GLAPI.
...
// Example usage
const record = await client.subsidiariess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/subsidiariess/123e4567-e89b-12d3-a456-426614174000',
