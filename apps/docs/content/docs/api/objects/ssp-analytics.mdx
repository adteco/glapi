---
title: SSP Analytics Object
description: SSP analytics schema and field reference
---

# SSP Analytics Object

Represents a ssp analytics entity in GLAPI.
...
- **Description**: Unique identifier for the ssp analytics
...
// Example usage
const record = await client.sspanalyticss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/ssp-analyticss/123e4567-e89b-12d3-a456-426614174000',
