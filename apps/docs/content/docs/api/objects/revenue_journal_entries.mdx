---
title: Revenue_journal_entries Object
description: revenue_journal_entries entity schema and field reference
---

# Revenue_journal_entries Object

Represents a revenue_journal_entries entity in GLAPI.
...
- **Description**: Unique identifier for the revenue_journal_entries
...
// Example usage
const record = await client.revenue_journal_entriess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/revenue_journal_entriess/123e4567-e89b-12d3-a456-426614174000',
