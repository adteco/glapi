---
title: Class Object
description: Class/Cost Center entity schema and field reference
---

# Class Object

Represents a class entity in GLAPI.
...
// Example usage
const record = await client.classess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/classess/123e4567-e89b-12d3-a456-426614174000',
