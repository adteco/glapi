---
title: Assembly Kit Object
description: Assembly/kit schema and field reference
---

# Assembly Kit Object

Represents a assembly kit entity in GLAPI.
...
- **Description**: Unique identifier for the assembly kit
...
// Example usage
const record = await client.assemblieskitss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/assemblies-kitss/123e4567-e89b-12d3-a456-426614174000',
