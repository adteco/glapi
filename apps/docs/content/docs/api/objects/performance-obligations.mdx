---
title: Performance Obligations Object
description: performance-obligations entity schema and field reference
---

# Performance Obligations Object

Represents a performance obligations entity in GLAPI.
...
- **Description**: Unique identifier for the performance obligations
...
response = requests.get(
    'https://api.glapi.io/api/performance-obligationss/123e4567-e89b-12d3-a456-426614174000',
