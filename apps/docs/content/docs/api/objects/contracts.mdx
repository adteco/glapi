...
description: Contract entity schema and field reference
---

# Contract Object

Represents a contract entity in GLAPI.
...
// Example usage
const record = await client.contractss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/contractss/123e4567-e89b-12d3-a456-426614174000',
