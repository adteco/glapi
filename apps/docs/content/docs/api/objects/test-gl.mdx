---
title: Test Gl Object
description: test-gl entity schema and field reference
---

# Test Gl Object

Represents a test gl entity in GLAPI.
...
- **Description**: Unique identifier for the test gl
...
// Example usage
const record = await client.testgls.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/test-gls/123e4567-e89b-12d3-a456-426614174000',
