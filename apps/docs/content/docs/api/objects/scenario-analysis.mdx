---
title: Scenario Analysis Object
description: Revenue scenario analysis schema
---

# Scenario Analysis Object

Represents a scenario analysis entity in GLAPI.
...
- **Description**: Unique identifier for the scenario analysis
...
// Example usage
const record = await client.scenarioanalysiss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/scenario-analysiss/123e4567-e89b-12d3-a456-426614174000',
