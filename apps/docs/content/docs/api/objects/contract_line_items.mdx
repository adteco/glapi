---
title: Contract Line Item Object
description: Contract line item schema and field reference
---

# Contract Line Item Object

Represents a contract line item entity in GLAPI.
...
- **Description**: Unique identifier for the contract line item
...
// Example usage
const record = await client.contract_line_itemss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/contract_line_itemss/123e4567-e89b-12d3-a456-426614174000',
