...
description: Payment entity schema and field reference
---

# Payment Object

Represents a payment entity in GLAPI.
...
// Example usage
const record = await client.paymentss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/paymentss/123e4567-e89b-12d3-a456-426614174000',
