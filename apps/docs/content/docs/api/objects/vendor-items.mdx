---
title: Vendor Item Object
description: Vendor item relationship schema
---

# Vendor Item Object

Represents a vendor item entity in GLAPI.
...
- **Description**: Unique identifier for the vendor item
...
// Example usage
const record = await client.vendoritemss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/vendor-itemss/123e4567-e89b-12d3-a456-426614174000',
