...
description: Warehouse entity schema and field reference
---

# Warehouse Object

Represents a warehouse entity in GLAPI.
...
// Example usage
const record = await client.warehousess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/warehousess/123e4567-e89b-12d3-a456-426614174000',
