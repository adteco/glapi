---
title: Tax Code Object
description: Tax code entity schema
---

# Tax Code Object

Represents a tax code entity in GLAPI.
...
response = requests.get(
    'https://api.glapi.io/api/tax-codess/123e4567-e89b-12d3-a456-426614174000',
