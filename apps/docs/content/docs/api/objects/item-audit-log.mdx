---
title: Item Audit Log Object
description: Item audit log schema
---

# Item Audit Log Object

Represents a item audit log entity in GLAPI.
...
- **Description**: Unique identifier for the item audit log
...
// Example usage
const record = await client.itemauditlogs.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/item-audit-logs/123e4567-e89b-12d3-a456-426614174000',
