---
title: Revenue Forecasting Object
description: Revenue forecasting schema
---

# Revenue Forecasting Object

Represents a revenue forecasting entity in GLAPI.
...
- **Description**: Unique identifier for the revenue forecasting
...
// Example usage
const record = await client.revenueforecastings.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/revenue-forecastings/123e4567-e89b-12d3-a456-426614174000',
