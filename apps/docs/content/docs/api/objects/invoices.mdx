...
description: Invoice entity schema and field reference
---

# Invoice Object

Represents a invoice entity in GLAPI.
...
// Example usage
const record = await client.invoicess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/invoicess/123e4567-e89b-12d3-a456-426614174000',
