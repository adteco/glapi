...
description: Subscription line item schema and field reference
---

# Subscription Item Object

Represents a subscription item entity in GLAPI.
...
// Example usage
const record = await client.subscriptionitemss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/subscription-itemss/123e4567-e89b-12d3-a456-426614174000',
