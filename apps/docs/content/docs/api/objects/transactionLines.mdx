---
title: TransactionLines Object
description: transactionLines entity schema and field reference
---

# TransactionLines Object

Represents a transactionlines entity in GLAPI.
...
- **Description**: Unique identifier for the transactionlines
...
// Example usage
const record = await client.transactionLiness.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/transactionLiness/123e4567-e89b-12d3-a456-426614174000',
