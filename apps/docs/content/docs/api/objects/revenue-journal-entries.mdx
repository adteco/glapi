---
title: Revenue Journal Entry Object
description: Revenue journal entry schema and field reference
---

# Revenue Journal Entry Object

Represents a revenue journal entry entity in GLAPI.
...
- **Description**: Unique identifier for the revenue journal entry
...
// Example usage
const record = await client.revenuejournalentriess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/revenue-journal-entriess/123e4567-e89b-12d3-a456-426614174000',
