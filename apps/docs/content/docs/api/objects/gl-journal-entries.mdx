---
title: GL Journal Entry Object
description: GL journal entry schema
---

# GL Journal Entry Object

Represents a gl journal entry entity in GLAPI.
...
- **Description**: Unique identifier for the gl journal entry
...
// Example usage
const record = await client.gljournalentriess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/gl-journal-entriess/123e4567-e89b-12d3-a456-426614174000',
