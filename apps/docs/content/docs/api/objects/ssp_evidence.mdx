---
title: Ssp_evidence Object
description: ssp_evidence entity schema and field reference
---

# Ssp_evidence Object

Represents a ssp_evidence entity in GLAPI.
...
- **Description**: Unique identifier for the ssp_evidence
...
// Example usage
const record = await client.ssp_evidences.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/ssp_evidences/123e4567-e89b-12d3-a456-426614174000',
