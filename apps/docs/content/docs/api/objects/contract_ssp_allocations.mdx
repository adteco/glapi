---
title: Contract_ssp_allocations Object
description: contract_ssp_allocations entity schema and field reference
---

# Contract_ssp_allocations Object

Represents a contract_ssp_allocations entity in GLAPI.
...
- **Description**: Unique identifier for the contract_ssp_allocations
...
// Example usage
const record = await client.contract_ssp_allocationss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/contract_ssp_allocationss/123e4567-e89b-12d3-a456-426614174000',
