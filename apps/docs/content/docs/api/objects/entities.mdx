---
title: Entity Object
description: Multi-type entity schema (Customer, Vendor, Employee, etc.)
---

# Entity Object

Represents a entity entity in GLAPI.
...
// Example usage
const record = await client.entitiess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/entitiess/123e4567-e89b-12d3-a456-426614174000',
