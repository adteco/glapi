---
title: Transaction Type Object
description: Transaction type schema
---

# Transaction Type Object

Represents a transaction type entity in GLAPI.
...
// Example usage
const record = await client.transactiontypess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/transaction-typess/123e4567-e89b-12d3-a456-426614174000',
