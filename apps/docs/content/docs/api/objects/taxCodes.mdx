---
title: TaxCodes Object
description: taxCodes entity schema and field reference
---

# TaxCodes Object

Represents a taxcodes entity in GLAPI.
...
- **Description**: Unique identifier for the taxcodes
...
// Example usage
const record = await client.taxCodess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/taxCodess/123e4567-e89b-12d3-a456-426614174000',
