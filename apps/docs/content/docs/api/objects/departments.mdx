...
description: Department entity schema and field reference
---

# Department Object

Represents a department entity in GLAPI.
...
// Example usage
const record = await client.departmentss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/departmentss/123e4567-e89b-12d3-a456-426614174000',
