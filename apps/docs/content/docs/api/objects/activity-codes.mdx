---
title: Activity Code Object
description: Activity code schema
---

# Activity Code Object

Represents a activity code entity in GLAPI.
...
response = requests.get(
    'https://api.glapi.io/api/activity-codess/123e4567-e89b-12d3-a456-426614174000',
