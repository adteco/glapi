---
title: Invoice Line Item Object
description: Invoice line item schema and field reference
---

# Invoice Line Item Object

Represents a invoice line item entity in GLAPI.
...
// Example usage
const record = await client.invoicelineitemss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/invoice-line-itemss/123e4567-e89b-12d3-a456-426614174000',
