---
title: GL Transaction Object
description: General ledger transaction schema
---

# GL Transaction Object

Represents a gl transaction entity in GLAPI.
...
- **Description**: Unique identifier for the gl transaction
...
// Example usage
const record = await client.gltransactionss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/gl-transactionss/123e4567-e89b-12d3-a456-426614174000',
