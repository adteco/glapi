---
title: GL Account Mapping Object
description: GL account mapping schema
---

# GL Account Mapping Object

Represents a gl account mapping entity in GLAPI.
...
- **Description**: Unique identifier for the gl account mapping
...
// Example usage
const record = await client.glaccountmappingss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/gl-account-mappingss/123e4567-e89b-12d3-a456-426614174000',
