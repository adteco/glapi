---
title: SSP Evidence Object
description: Standalone selling price evidence schema
---

# SSP Evidence Object

Represents a ssp evidence entity in GLAPI.
...
- **Description**: Unique identifier for the ssp evidence
...
// Example usage
const record = await client.sspevidences.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/ssp-evidences/123e4567-e89b-12d3-a456-426614174000',
