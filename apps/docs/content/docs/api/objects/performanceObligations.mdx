---
title: PerformanceObligations Object
description: performanceObligations entity schema and field reference
---

# PerformanceObligations Object

Represents a performanceobligations entity in GLAPI.
...
- **Description**: Unique identifier for the performanceobligations
...
// Example usage
const record = await client.performanceObligationss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/performanceObligationss/123e4567-e89b-12d3-a456-426614174000',
