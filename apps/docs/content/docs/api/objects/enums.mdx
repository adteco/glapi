---
title: Enums Object
description: enums entity schema and field reference
---

# Enums Object

Represents a enums entity in GLAPI.
...
- **Description**: Unique identifier for the enums
...
// Example usage
const record = await client.enumss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/enumss/123e4567-e89b-12d3-a456-426614174000',
