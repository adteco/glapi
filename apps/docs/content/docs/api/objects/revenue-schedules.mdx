---
title: Revenue Schedule Object
description: Revenue schedule schema and field reference
---

# Revenue Schedule Object

Represents a revenue schedule entity in GLAPI.
...
- **Description**: Unique identifier for the revenue schedule
...
// Example usage
const record = await client.revenuescheduless.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/revenue-scheduless/123e4567-e89b-12d3-a456-426614174000',
