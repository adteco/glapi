---
title: Inventory Tracking Object
description: Inventory tracking schema and field reference
---

# Inventory Tracking Object

Represents a inventory tracking entity in GLAPI.
...
- **Description**: Unique identifier for the inventory tracking
...
// Example usage
const record = await client.inventorytrackings.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/inventory-trackings/123e4567-e89b-12d3-a456-426614174000',
