...
description: Address object schema
---

# Address Object

Represents a address entity in GLAPI.
...
// Example usage
const record = await client.addressess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/addressess/123e4567-e89b-12d3-a456-426614174000',
