...
description: Chart of accounts entry schema and field reference
---

# Account Object

Represents a account entity in GLAPI.
...
// Example usage
const record = await client.accountss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/accountss/123e4567-e89b-12d3-a456-426614174000',
