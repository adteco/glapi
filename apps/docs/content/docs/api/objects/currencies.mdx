...
description: Currency entity schema
---

# Currency Object

Represents a currency entity in GLAPI.
...
// Example usage
const record = await client.currenciess.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/currenciess/123e4567-e89b-12d3-a456-426614174000',
