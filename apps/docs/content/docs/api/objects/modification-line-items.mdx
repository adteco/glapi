---
title: Modification Line Item Object
description: Contract modification line item schema
---

# Modification Line Item Object

Represents a modification line item entity in GLAPI.
...
- **Description**: Unique identifier for the modification line item
...
// Example usage
const record = await client.modificationlineitemss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/modification-line-itemss/123e4567-e89b-12d3-a456-426614174000',
