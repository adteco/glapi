---
title: Kit Component Object
description: Assembly/kit component schema and field reference
---

# Kit Component Object

Represents a kit component entity in GLAPI.
...
- **Description**: Unique identifier for the kit component
...
// Example usage
const record = await client.kitcomponentss.get.query({
  id: '123e4567-e89b-12d3-a456-426614174000'
});
...
response = requests.get(
    'https://api.glapi.io/api/kit-componentss/123e4567-e89b-12d3-a456-426614174000',
