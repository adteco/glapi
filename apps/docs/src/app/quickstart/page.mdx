...
const response = await fetch('https://api.glapi.net/api/v1/customers', {
  headers: {
...
response = requests.get('https://api.glapi.net/api/v1/customers', headers=headers)
...
response = requests.post('https://api.glapi.net/api/v1/customers', 
