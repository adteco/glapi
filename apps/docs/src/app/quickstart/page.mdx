export const metadata = {
  title: 'Quickstart',
  description:
    'This guide will get you all set up and ready to use the the GLAPI project management platform',
}

# Quickstart

This guide will get you all set up and ready to use the GLAPI project management platform. We'll cover how to setup a project, look at the data and trigger a sync. {{ className: 'lead' }}
...
There are multiple ways to connect a project but for now, let's take the manual approach. Click on the projects link and in the upper right select "Create Project" 
