...
If you encounter any issues while using Kurrent, our support team is ready to assist you. Filing a support ticket through your dashboard is the most efficient way to get help. {{ className: 'lead' }}
...
<Row>
  <Col>
    ...
    1. Log in to your Kurrent dashboard
