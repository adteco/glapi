...
const vendorCreditFormSchema = z.object({
  ...
  transactionDate: z.string().min(1, "Credit date is required"),
  relatedBillId: z.string().optional(),
  memo: z.string().max(1000, "Memo too long").optional(),
  lines: z.array(creditLineSchema).min(1, "At least one line item is required"),
});
...
export default function NewVendorCreditPage() {
  ...
  const handleSubmit = async (values: VendorCreditFormValues) => {
    // TODO: Connect to actual TRPC mutation when backend is ready
    console.log('Vendor Credit data:', values);
    toast.success('Vendor credit created successfully');
    router.push('/transactions/purchasing/vendor-credits');
  };
  ...
  if (!orgId) {
    return <div className="container mx-auto py-10"><p>Please select an organization to create vendor credits.</p></div>;
  }
  ...
  return (
    <div className="container mx-auto py-6 px-4 max-w-[1600px]">
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold">New Vendor Credit</h1>
          <p className="text-muted-foreground">Record a credit from a vendor (bill credit)</p>
        </div>
      </div>
        ...
        <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Select the vendor for this credit</CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Link to original bill" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Set the date for this credit</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <FormField
            ...
            <CardHeader>
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <CardDescription>Add items for this vendor credit</CardDescription>
                </div>
                <Button
                  type="button"
                  variant="outline"
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Add any notes for this vendor credit</CardDescription>
            </CardHeader>
            <CardContent>
              <FormField
                control={form.control}
