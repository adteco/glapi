...
export const metadata: Metadata = {
  title: 'Terms of Service - Adteco',
  description: 'Read the terms of service for using Adteco.',
}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-400 mb-2">Terms of use apply to your usage of Adteco's services and our obligations to you.</p>
          ...
          <div className="max-w-4xl mx-auto text-gray-400">
            <div className="prose prose-lg prose-invert max-w-none">
              ...
              <p>Welcome to the Adteco Website and Services. We are confident that you will find our Services useful. These Terms of Use (the "TOU") cover several different situations, so please refer to the following definitions for clarification:</p>
              <ul>
                ...
                <li><strong>Adteco:</strong> Refers to Adteco, LLC, a US-based company. Where the present TOU refer to "Adteco", they may refer to Adteco, LLC and its subsidiaries and affiliates, and / or their respective shareholders, officers, directors, employees, agents, partners, principals, representatives, successors and assigns (collectively "Representatives"), depending on the context. Any reference to "we", "our", or "us" in these TOU refers to Adteco.</li>
                <li><strong>Fees:</strong> Means the fees for provision of the Services as described on the Adteco Website or otherwise set out in our Portal, including but not limited to Subscription Fees, Additional Client Fees, Payment Service Fees (as applicable).</li>
                <li><strong>Payment Service Fees:</strong> Means the service fee for the processing of payments as described on the Adteco Website or otherwise set out in your Portal.</li>
                ...
                <li><strong>Services:</strong> Refers to the software services accessed through the Website that Adteco has developed and / or licensed that allow you to manage various business processes, receive payments from Clients, and various related functionalities. You may purchase a "Subscription" to use the Services.</li>
                ...
                <li><strong>Website:</strong> Is the website located at https://www.adteco.com {/* TODO: Confirm correct URL */} which is owned and operated by Adteco, and includes all subdomains and subpages, present and future.</li>
              </ul>
              ...
              <ul>
                <li>Not use the Website or Services in any manner that in any way violates these TOU or any other applicable policy posted on the Website or in the Services by Adteco;</li>
                <li>Not use the Website or Services in any manner that violates any intellectual property rights of Adteco or any third party;</li>
                ...
                <li>Not use the Website or Services in any manner to propagate software viruses, Trojan horses, worms, or any other malicious or non-malicious computer code, files, or programs that are designed or intended to disrupt, damage, limit or interfere with the proper function of any software, hardware, or telecommunications equipment in any form whether belonging to Adteco or a third party, or to damage or obtain unauthorized access to any system, data, password or other information (whether personal data or not) of Adteco, other Services Users, or any other third party;</li>
                <li>Not: (1) take any action that imposes or may impose (as determined by Adteco in its sole discretion) an unreasonable or disproportionately large load on Adteco's (or its third party providers') infrastructures; (2) interfere or attempt to interfere with the proper functioning of the Website or Services or any activities conducted on or via the Website or Services; (3) bypass any measures Adteco may use to prevent or restrict access to the Services or any element thereof; (4) use manual or automated software, devices, or other processes to "crawl" or "spider" any page or portion of the Website or Services; or (5) harvest or scrape any content from the Website or Services in an unreasonable manner;</li>
                ...
                <li>Not use the Website or Services to advertise or promote products or services that are not expressly approved in advance in writing by Adteco, or as otherwise permitted by the nature of the Services;</li>
              ...
              <h3>a. Free Trial</h3>
              <p>You may begin your use of the Services with a free trial. Subject to clause 7, the free trial period of your account lasts up to fourteen days, or as otherwise agreed in writing by Adteco during sign-up (the "Free Trial Period"). Free trials are for new Users only. Adteco reserves the right, in its absolute discretion, to determine your free trial eligibility.</p>
              ...
              <p>By submitting Account Information, you represent and warrant that the Account Information is true and accurate to the best of your knowledge. Submitting false or misleading Account Information may result in you being banned from using the Services, at our sole discretion. Adteco reserves the right to verify your submitted Account Information for any reason.</p>
              <p>Adteco retains absolute discretion to refuse to approve your account for any reason, including but not limited to if we believe you have submitted false or misleading Account Information. Without limiting the generality of the Disclaimer of Warranties further in these TOU, Adteco and / or its Representatives shall not be responsible for any losses or damages, pecuniary or otherwise, to you resulting from Adteco's refusal to approve your account, and Adteco disclaims any responsibility thereto.</p>
              ...
              <p>The amount of the monthly or annual Subscription Fees for each plan level are available on the Adteco Website or via the Portal and will be displayed and charged in U.S. Dollars (USD). Your currency may be converted upon payment depending on your location and / or credit card agreement. By signing up for a Subscription you agree to pay the Subscription Fees presented to you upon signing up, plus any applicable taxes.</p>
              ...
              <p>All payments are made using a secure https:// connection, and payment processing is handled through the "Third-Party Payment Processor" Stripe, though this is subject to change without notice. The Third-Party Payment Processor currently accepts certain credit cards as payment options but these are subject to change without notice. Once transactions are accepted by the Third-Party Payment Processor, they are processed in accordance with their program rules and procedures and Terms of Use. Adteco and the Third-Party Payment Processor are unaffiliated companies and Adteco has no influence on the operations of the Third-Party Payment Processor. Adteco and / or its Representatives shall in no way be held responsible for any losses or damages, direct or indirect, pecuniary or otherwise, resulting from any error or failure on the part of the Third-Party Payment Processor.</p>
              <p>All Billing Information is collected by the Third-Party Payment Processor, on their own secured servers. Adteco does not have access to your full credit card information, nor can it be responsible for any breach of information caused by faulty programming or malicious users on the servers of the Third-Party Payment Processor. Non-financial information (like transaction history) will, however, be available to Adteco for invoice-making and record-keeping purposes.</p>
              <p>If you have a valid coupon code, it shall be applied and displayed during the payment process. In the event that an incorrect discount is applied, Adteco reserves the right to refuse or cancel any Subscriptions listed at an incorrect discount. Adteco reserves the right to refuse or cancel any such Subscriptions whether or not the Subscription has been confirmed and the User's credit card charged.</p>
              <h3>c. Payment of Additional Fees (Usage-Based)</h3>
              <p>Your Subscription may include usage limits (e.g., number of users, data processing volume, API calls, etc.). If you exceed these limits, you may be charged additional fees as described on the Adteco Website or Portal ("Usage Fees"). By signing up for a Subscription, you authorize Adteco to charge your payment method and you agree to pay such Usage Fees if applicable, plus any applicable taxes.</p>
              <h3>d. Failure of Automatic Payment</h3>
              <p>Should automatic payment of any Subscription Fees or Usage Fees fail to occur for any reason, your account may be suspended. Adteco may issue you an electronic invoice via email indicating that you must proceed manually, within a certain deadline date, with the full payment of the Fees as indicated on the invoice. Your account may be reactivated upon receipt of the payment.</p>
              <h3>e. Modification of the Fees</h3>
              <p>Adteco, in its sole discretion and at any time, may modify the Subscription Fees or Usage Fees on written notice to you. Any modification(s) will become effective at the end of the then-current Billing Period or as specified in the notice. Adteco will provide you with a reasonable prior notice of any change in Fees to give you an opportunity to terminate or change your Subscription before such modification(s) becomes effective. Your continued use of the Services after the Fees modification(s) comes into effect constitutes your agreement to pay the modified Fees at the modified rates.</p>
              ...
              <p>By accepting a Proposal (e.g., clicking acceptance, signing electronically): (i) you agree to pay the Service Provider the price quoted for the services outlined in the Proposal; and (ii) you agree to abide by the additional terms presented (the "Service Terms"), which are strictly between you and the Service Provider. Adteco is not a party to the legal relationship between you and the Service Provider. The Service Provider alone is responsible for any loss, damages, claims, etc., related to the services provided or violation of the Service Terms. Adteco disclaims any responsibility.</p>
              <h3>b. Payments Made Through the Services</h3>
              <p>Payments to Service Providers through Adteco may use bank ACH transfer or credit card, facilitated by partners like Stripe or Plaid ("Payment Facilitators").</p>
              <p>Adteco and Payment Facilitators are unaffiliated. Adteco is not responsible for errors or failures by Payment Facilitators.</p>
              <p>By making a payment, you acknowledge and agree:</p>
              <ul>
                <li>You authorize Adteco, via Payment Facilitators, to process payments on behalf of the Service Provider. Adteco acts as an agent for the Service Provider for payment collection.</li>
                <li>You authorize the Payment Facilitator to handle the payment.</li>
                <li>Adteco provides only collection services and is not liable for the services provided by the Service Provider.</li>
                <li>Payments will be processed according to the terms agreed with the Service Provider.</li>
                <li>"Adteco" or similar may appear as the merchant, but Adteco is not liable for disputed transactions related to non-supply of services by the Service Provider.</li>
                <li>You authorize Adteco to vary payment amounts based on instructions from the Service Provider reflecting agreed variations, without needing separate notification from Adteco.</li>
                ...
                <li>Unpaid debits/payments may incur fees payable to Adteco, plus collection costs.</li>
                <li>Adteco may re-process unsuccessful payments based on Service Provider instructions.</li>
                <li>Direct all disputes regarding service fees to the Service Provider. Adteco acts only as an agent.</li>
                <li>Direct disputes about payments themselves to the Service Provider and your financial institution.</li>
                <li>Adteco is not liable for refunding disputed payments. You agree to reimburse Adteco for losses from claims against Adteco related to disputed payments (see Indemnity section).</li>
              ...
              <p>This section applies to Users (Service Providers) receiving payments via Adteco.</p>
              <h3>a. Withholding Fees</h3>
              <p>Adteco may withhold remitting fees to you for legitimate reasons, including: (i) non-payment of your Subscription Fees; (ii) payment value appears excessive; (iii) indication of fraudulent or illegal activity. We may inform you and allow rectification, but Adteco's final decision to release or withhold fees is binding. Adteco is not liable for losses resulting from withholding fees under these circumstances.</p>
              <h3>b. Disputes</h3>
              <p>Adteco plays no role in adjudicating payment disputes between you and your Client. However, Adteco retains discretion to return paid fees to a Client if a payment is disputed. Adteco is not liable for losses resulting from fee disputes between you and a Client.</p>

              <h2>10. Proprietary and Intellectual Property Rights; Your Data</h2>
              <h3>a. Adteco's Rights</h3>
              <p>You acknowledge the Website and Services contain proprietary and confidential information protected by IP laws. Adteco and/or its licensors own all right, title, and interest in the Website, Services, and content (except User Data), including all Intellectual Property Rights ("IP Rights"). All rights not specifically granted are reserved.</p>
              ...
              <p>The content, arrangement, layout, trademarks, photos, logos, videos, audio, images, text, and code ("Computer Code") are proprietary to Adteco (owned or licensed) and may not be used without express permission, except as permitted by functionality or these TOU. Unauthorized use may violate laws, and Adteco may take action.</p>
              ...
              <p>Your access to inputted Data depends on full payment of Subscription Fees. Maintain copies of all Data inputted. Adteco follows best practices for data backup but doesn't guarantee against data loss. Adteco is not obligated to retain your Data after Subscription termination.</p>
              <p>Adteco is not liable for losses from Data loss or deletion after termination.</p>
              <h3>c. Access to Your Data by Third Party Applications</h3>
              <p>If you enable third-party apps (e.g., QuickBooks, Xero, NetSuite, Procore, BigCommerce, etc.) for use with the Services, you allow providers of those apps to access your Data as needed for interoperation. Adteco is not liable for losses from disclosure, modification, or deletion of your Data by these third-party providers.</p>
              <h3>d. Submitted Information (Feedback)</h3>
              <p>If you provide suggestions for improvements or ideas ("Feedback"), Adteco owns all rights to the Feedback and can use it without restriction or compensation to you. You irrevocably assign all rights to the Feedback to Adteco and waive moral rights. You agree to assist Adteco in documenting and perfecting these rights.</p>
              ...
              <p>Adteco or Users may provide links to external websites/services not covered by these TOU. Access third-party resources at your own risk. Adteco is not responsible for your use of, or privacy on, external sites. Check their terms and privacy policies. Adteco makes no claim/warranty about linked content or services.</p>
              <p>Adteco is not liable for damages arising from: (1) use of linked sites/services; (2) viruses/malware from linked sites; (3) reliance on linked content/products/services; or (4) actions of linked site operators.</p>

              <h2>13. Interruption of the Website or Services</h2>
              <p>The Website or Services may be temporarily unavailable for maintenance/modifications. Adteco will try to minimize downtime but is not liable for losses resulting from interruptions.</p>

              <h2>14. Termination of the Website or Services or Your Access</h2>
              <p>Adteco may, in its sole discretion, with or without cause, block your access, revoke credentials, or terminate your use of the Website/Services immediately if Adteco believes you violated these TOU or acted improperly.</p>
              <p>You can end your access by canceling your Subscription via your dashboard or contacting <a href="mailto:support@adteco.com">support@adteco.com</a>.</p>
              <p>Adteco may discontinue the Website/Services at any time. Adteco is not liable for losses from termination of your access or the Services.</p>
              <p>Termination ends these TOU between you and Adteco. Provisions meant to survive termination (IP, disclaimers, indemnity, liability limitations) will remain in effect.</p>
              ...
              <p>Information provided by Adteco is intended to be accurate but may contain errors or change. Adteco is not liable for losses resulting from errors, omissions, or reliance on information.</p>
              ...
              <p>Adteco does not warrant: (i) security or availability at specific times/locations; (ii) correction of defects/errors; (iii) content is free of viruses/harmful components; (iv) functionality works equally across devices; or (v) results of using the Website/Services meet your requirements.</p>
              <p>Adteco assumes no responsibility for third-party content (including User content).</p>
              ...
              <h2>17. Indemnity</h2>
              <p>You agree to indemnify, defend, and hold harmless Adteco and its Representatives from damages, liabilities, costs, expenses (including attorneys' fees), claims, or demands arising from: (i) your use/connection to the Website/Services; (ii) your participation in activities arising from the Website/Services; (iii) your violation of these TOU or the Privacy Policy; or (iv) your violation of third-party rights.</p>

              <h2>18. Governing Law and Applicable Jurisdiction</h2>
              <p>These TOU and your use of the Website/Services shall be governed by and construed in accordance with the laws of the State of [Your State, e.g., Colorado] and the federal laws of the United States applicable therein, without regard to conflict of law provisions. You agree that any legal action or proceeding between you and Adteco shall be brought exclusively in the state or federal courts located in [Your County/City, e.g., Denver County, Colorado].</p> {/* TODO: Update State/County/City */} 
              <p>Notwithstanding the foregoing, Adteco may bring action against you in your jurisdiction: (i) for injunctive relief; (ii) to obtain a judgment if a [Your State] court judgment may not be enforced there; or (iii) to enforce a [Your State] judgment obtained against you.</p>
              ...
              <ul>
                  ...
                  <li><strong>Delays:</strong> Adteco is not liable for failures due to causes beyond reasonable control (incl. force majeure).</li>
                  ...
                  <li><strong>Notices:</strong> Notices must be in writing via email. Notices to Adteco: <a href="mailto:support@adteco.com">support@adteco.com</a> (or other notified address). Notices to you: email associated with your account.</li>
              </ul>
