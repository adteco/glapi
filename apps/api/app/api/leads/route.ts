...
import { LeadService, NewLeadSchema } from '@glapi/api-service';
...
export async function POST(request: NextRequest) {
  try {
    ...
    const parsedData = NewLeadSchema.safeParse({
      ...body,
    ...
    // Create the lead
    const result = await leadService.createLead(parsedData.data);
...
export async function GET(request: NextRequest) {
  try {
    ...
    const orderBy = (searchParams.get('orderBy') as 'leadName' | 'createdAt') || 'leadName';
